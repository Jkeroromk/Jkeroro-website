...
export default function LinkforBio() {
  ...
  const statusText = isAdmin && isOnline ? "Online" : `Last Active: ${lastActivity || "Unknown"}`;
  ...
  return (
    <>
      ...
      {showLogin && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 bg-black p-4 text-white rounded z-50">
          {isAdmin ? (
            <button
