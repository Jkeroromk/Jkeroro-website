...
const Tabs = () => {
  return (
    <div className="mt-2 flex flex-col justify-center items-center w-full px-4 z-10">
      ...
      >
        <div className="flex flex-col items-center bg-white bg-opacity-40 border-2 border-black py-4 rounded-3xl mt-10 w-full sm:w-[550px] transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_20px_white] heartbeat">
      ...
      <a
        ...
        className="flex flex-col items-center w-full"
      >
        <div className="flex flex-col items-center bg-white bg-opacity-40 border-2 border-black py-6 rounded-3xl mt-16 w-full sm:w-[550px] transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_20px_white] heartbeat">
          <h1 className="text-xl font-extrabold text-black hover:text-white transition-colors duration-300">
            Rednote
          </h1>
      ...
      <a
        ...
        className="flex flex-col items-center w-full"
      >
        <div className="flex flex-col items-center bg-white bg-opacity-40 border-2 border-black py-6 rounded-3xl mt-10 w-full sm:w-[550px] transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_20px_white] heartbeat">
          <h1 className="text-xl font-extrabold text-black hover:text-white transition-colors duration-300">
            Discord
          </h1>
          <h2 className="text-sm font-semibold text-black hover:text-white transition-colors duration-300">
